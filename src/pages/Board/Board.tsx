    ...
    <div className="drawer drawer-end">
      ...
      <div className="drawer-side">
        ...
        <section className="menu min-h-full w-80 bg-zinc-700 p-4 text-base-content">
          ...
          <div className="flex w-full items-center justify-center gap-2 rounded-xl bg-zinc-600 font-medium capitalize text-white shadow-lg">
            <p
              className={`w-1/2 rounded-xl p-2 text-center ${isCard && "bg-zinc-900"}`}
              onClick={toggleIsCard}
            >
              cards
            </p>
            <p
