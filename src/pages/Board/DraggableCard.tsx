...
export default function DraggableCard({ cardId }: { cardId: string }) {
  ...
  return (
    <div className="flex aspect-[3] w-64 flex-shrink-0 flex-grow-0 items-start justify-start gap-2.5 overflow-hidden rounded-xl border border-black bg-zinc-700 px-6 py-[18px]">
