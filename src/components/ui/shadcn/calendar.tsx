  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        focus-within:z-20 
        [&:has([aria-selected].day-outside)]:bg-slate-800/50 
        [&:has([aria-selected])]:bg-slate-800`,
        day: cn(
        ...
        day_outside:
          "day-outside  opacity-50   text-slate-400  aria-selected:bg-slate-800/50 aria-selected:text-slate-400",
